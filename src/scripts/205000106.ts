...
const effect_205000106_daily_scene: CardEffect = {
  ...
  description: '创痕1，同名1回合1次，主要阶段，舍弃1张黄色手牌：将卡组1张无颜色限制的非神蚀单位放置到战场，其非关键词效果无效，伤害1力量0，离场时放逐。',
  ...
  onQueryResolve: async (instance, gameState, playerState, selections, context) => {
    ...
    if (!selected || selected.cardlocation !== 'DECK' || selected.type !== 'UNIT' || selected.godMark || !hasNoColorRequirement(selected)) return;
